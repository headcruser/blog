...
// ALMACENAR EJEMPLOS EN EL INDEX
    ...
    // $usuario=new Usuario();
        ...
        // $noUsuarios = count( $datos );
        // // $campos=$usuario->getNombresColumnas($datos);
        // self::$template->assign('noUsuarios',$noUsuarios);
        // self::$template->assign('datos',$datos);
        // self::$template->assign('campos',$campos);


        //insertar nuevo usuario
        // $usuario->nombre="cesar";
        // $usuario->email="tortis_91@hotmail.com";
        ...
        // echo "<pre>";
        // $loginusuario=$usuario->Ejecutar("PA_LOGIN",array("headcruser@gmail.com","123456"));
        // die(print_r($loginusuario));